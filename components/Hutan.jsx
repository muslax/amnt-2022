...
export default function Hutan ({ idr, editable }) {
    ...
    return (
        <div className="my-10">
            <h3 className="text-blue-500 font-bold mb-3">Hasil Hutan</h3>
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="bg-gray-400 text-white whitespace-nowrap">
                            ...
                            <td className="p-2 border-l">Jumlah dikonsumsi</td>
                    ...
                    {daftar.map((item, index) => (
                        ...
                        >
                            ...
                            <td className="p-2 border-l border-gray-300">{item.satuan}</td>
            ...
            <table className="w-full text-sm">
                <tbody>
                    ...
                    <Row label="Satuan:">
                        <Textual model={model} setModel={setModel} field="satuan" />
                    </Row>
